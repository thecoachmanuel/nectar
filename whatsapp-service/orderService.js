...
async function createWhatsAppOrder(db, {
  ...
  const orderDoc = {
    ...
    customerEmail: customerEmail || `customer_${orderSerialNo.toLowerCase()}@errandshopgroceries.com`,
    ...
    statusTimeline: [
      {
        status: "pending",
        timestamp: new Date(),
        note: "Order placed via Errandshop WhatsApp Bot",
      },
    ],
    notes: "Placed via Errandshop WhatsApp Bot",
    isPos: false,
    createdAt: new Date(),
    updatedAt: new Date(),
  };
