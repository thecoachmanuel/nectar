...
export default function ItemsReportPage() {
  ...
  return (
    <div className="pb-16 space-y-6 animate-in fade-in">
      ...
      {/* Header */}
      <div>
        <h2 className="text-2xl font-bold text-[#14142B] mb-1">Items Performance Report</h2>
        <p className="text-sm text-[#6E7191]">Track sales volume, quantities sold, and total revenue across all catalog items.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
        <div className="bg-white p-5 rounded-2xl shadow-sm border border-[#EFF0F6] flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-semibold text-[#6E7191] uppercase tracking-wider">Catalog Items</p>
            <h3 className="text-xl font-bold text-[#14142B]">{reports.length} Items</h3>
          </div>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl shadow-sm border border-[#EFF0F6] flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-semibold text-[#6E7191] uppercase tracking-wider">Total Items Sales</p>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-[#EFF0F6]">
        <div className="p-4 sm:p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#EFF0F6]">
          <h3 className="font-semibold text-lg text-[#14142B]">Items Sales Breakdown</h3>
        ...
        <div className="overflow-x-auto custom-scrollbar">
          <table className="w-full text-left whitespace-nowrap">
            ...
            <tbody className="divide-y divide-[#EFF0F6]">
              {loading ? (
                <tr><td colSpan={6} className="p-8 text-center text-[#6E7191]">Loading items report...</td></tr>
              ) : filteredReports.length === 0 ? (
                <tr><td colSpan={6} className="p-8 text-center text-[#6E7191]">No items matching your criteria</td></tr>
              ) : (
