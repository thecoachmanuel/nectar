        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="flex items-center justify-between mb-6">
            <label className="flex items-center gap-2 cursor-pointer group">
              <div className={`w-4 h-4 rounded-[4px] border flex items-center justify-center transition-colors ${rememberMe ? 'bg-[#ff006b] border-[#ff006b]' : 'bg-white border-[#a0a3bd] group-hover:border-[#ff006b]'}`}>
            ...
            <Link href="#" className="capitalize text-xs font-medium transition text-[#ff006b] hover:text-rose-600">
              Forget Password?
            </Link>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <Link href="/signup" className="text-xs font-medium text-[#ff006b] hover:text-rose-600 transition-colors">
              Sign Up
            </Link>
          </div>
          ...
          <div>
            ...
            <button type="button" className="w-full h-12 text-center capitalize font-medium rounded-2xl border border-[#ff006b] text-[#ff006b] bg-white hover:bg-[#fff5f9] transition-colors">
              Login as guest
            </button>
          </div>
        </form>
